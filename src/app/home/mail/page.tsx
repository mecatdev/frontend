              ...
              >
                <div className="flex-1 min-w-0 space-y-1">
                  <div className="flex items-center justify-between gap-2">
                    <span
                      className={`text-sm ${mail.read ? "font-normal text-muted-foreground" : "font-semibold"}`}
                    >
                      {mail.from}
                    </span>
                  ...
                  <div className="flex items-center gap-2">
                    <p
                      className={`text-sm truncate ${mail.read ? "text-muted-foreground" : "text-foreground font-medium"}`}
                    >
                      {mail.subject}
                    </p>
                    {!mail.read && (
